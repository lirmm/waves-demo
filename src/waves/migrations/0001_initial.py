# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2016-11-23 10:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default', models.TextField(blank=True, help_text='Runner init param default value', max_length=500, null=True, verbose_name='Default')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input', models.ForeignKey(help_text='Associated input', on_delete=django.db.models.deletion.CASCADE, related_name='input_samples', to='waves.ServiceInput')),
                ('service', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='services_sample', to='waves.Service')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('srv_input', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, blank=True, chained_field='submission', chained_model_field='service', help_text='Output is valued from an input', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='to_outputs', to='waves.ServiceInput')),
                ('srv_output', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_input_submission', to='waves.ServiceOutput')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dependent_input', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='waves.ServiceInput')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Output is valued from an input', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='to_output', to='waves.ServiceOutputFromInputSubmission'),
        ),
        migrations.AddField(
            model_name='serviceoutput',
            name='service',
        ...
        migrations.AlterUniqueTogether(
            name='serviceinput',
            unique_together=set([('name', 'service', 'editable', 'param_type')]),
        ),
        migrations.AlterUniqueTogether(
            name='serviceexitcode',
