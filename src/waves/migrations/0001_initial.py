    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(-1, 'Unknown'), (0, 'Created'), (1, 'Prepared for run'), (2, 'Queued'), (3, 'Running'), (4, 'Suspended'), (5, 'Run completed'), (6, 'All Done'), (7, 'Cancelled'), (9, 'In Error')], default=0, help_text='Job current run status', verbose_name='Job status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(-1, 'Unknown'), (0, 'Created'), (1, 'Prepared for run'), (2, 'Queued'), (3, 'Running'), (4, 'Suspended'), (5, 'Run completed'), (6, 'All Done'), (7, 'Cancelled'), (9, 'In Error')], help_text=b'History job status', null=True, verbose_name=b'Job Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('param_type', models.IntegerField(choices=[(0, 'Not used'), (2, 'Simple (-[name] value)'), (1, 'Named (--[name]=value)'), (3, 'Option (-[name])'), (5, 'Named option (--[name])'), (4, 'Positional')], default=0, editable=False, null=True, verbose_name='Parameter Type')),
