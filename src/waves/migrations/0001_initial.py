# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-17 14:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, waves.models.base.ExportAbleMixin, waves.models.adaptors.DTOMixin),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('runner', models.ForeignKey(help_text='Service job runs adapter', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='submission_runs', to='waves.Runner')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_pattern', models.CharField(default='%s', help_text="Pattern used when dependent on any input '%s'", max_length=100, verbose_name='File name / pattern')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseparam_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='waves.BaseParam')),
                ('max_size', models.BigIntegerField(default=None, help_text='in Ko', verbose_name='Maximum allowed file size ')),
        ...
        migrations.CreateModel(
            name='JobRunParams',
            fields=[
                ('adaptorinitparam_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='waves.AdaptorInitParam')),
            ],
        ...
        migrations.AddField(
            model_name='fileinputsample',
            name='submission',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='submission_samples', to='waves.Submission'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='jobrunparams',
            name='job',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_run_params', to='waves.Job'),
        ),
        migrations.AlterUniqueTogether(
            name='joboutput',
