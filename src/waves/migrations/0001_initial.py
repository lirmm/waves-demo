# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-07-22 15:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[[-1, 'Unknown'], [0, 'New'], [2, 'Queued'], [1, 'Prepared for run'], [3, 'Running'], [6, 'Done'], [5, 'Completed'], [7, 'Cancelled'], [4, 'Suspended'], [9, 'In Error']], default=0, help_text='Job current run status', verbose_name='Job status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[[-1, 'Unknown'], [0, 'New'], [2, 'Queued'], [1, 'Prepared for run'], [3, 'Running'], [6, 'Done'], [5, 'Completed'], [7, 'Cancelled'], [4, 'Suspended'], [9, 'In Error']], help_text='History job status', verbose_name='Job Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('exit_code', models.IntegerField(primary_key=True, serialize=False, verbose_name='Exit code value')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config_file', models.FilePathField(default='/home/marc/Documents/sources/waves/config/waves.env', editable=False, verbose_name='Configuration file')),
        ...
        migrations.AddField(
            ...
            name='from_input',
            field=models.OneToOneField(blank=True, help_text='Output is valued from an input', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='to_output', to='waves.ServiceInput'),
        ),
        migrations.AddField(
            model_name='serviceoutput',
            name='service',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text=b'Dependent on another input value', null=True, on_delete=django.db.models.deletion.SET_NULL, to='waves.ServiceInput'),
        ),
        migrations.AddField(
            model_name='serviceinputsample',
            name='input',
            field=models.ForeignKey(help_text=b'Associated input', on_delete=django.db.models.deletion.CASCADE, related_name='input_samples', to='waves.ServiceInput'),
        ),
        migrations.AddField(
            model_name='serviceinputsample',
            name='service',
        ...
        migrations.AddField(
            model_name='jobinput',
            name='srv_input',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='waves.ServiceInput'),
        ),
        migrations.AddField(
            model_name='job',
            name='service',
