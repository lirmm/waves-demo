# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-13 16:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('param_type', models.IntegerField(choices=[(1, 'Valuated param (--param_name=value)'), (2, 'Simple param (-param_name value)'), (3, 'Option param (-param_name)'), (5, 'Option named param (--param_name)'), (4, 'Positional param (name not used)')], default=4, editable=False, verbose_name='Parameter Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cmd_parser', models.CharField(blank=True, help_text='Service job submission command', max_length=255, null=True, verbose_name='Parser class')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maintenance', models.BooleanField(default=False, help_text='Globally set waves as ', verbose_name='Maintenance flag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cmd_format', models.IntegerField(choices=[(1, 'Valuated param (--param_name=value)'), (2, 'Simple param (-param_name value)'), (3, 'Option param (-param_name)'), (5, 'Option named param (--param_name)'), (4, 'Positional param (name not used)')], default=4, help_text='Command line pattern', verbose_name='Command line format')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='sampledepparam',
            name='related_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_samples', to='waves.BaseParam'),
        ),
        migrations.AddField(
            model_name='sampledepparam',
            name='sample',
