# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-01-06 16:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseparam_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='waves.BaseParam')),
                ('extensions', models.CharField(blank=True, help_text='Comma separated list of extension', max_length=200, null=True, validators=[waves.utils.validators.validate_list_comma], verbose_name='Extensions')),
        ...
        migrations.AddField(
            ...
            name='related_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dependents_params_sample', to='waves.BaseParam'),
        ),
        migrations.AddField(
            model_name='sampledepparam',
            name='sample',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dependents_inputs_sample', to='waves.FileInputSample'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='baseparam',
            name='submission',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='all_inputs', to='waves.Submission'),
        ),
        migrations.CreateModel(
