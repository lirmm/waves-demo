# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2016-12-12 16:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clazz', models.CharField(help_text='Runner adaptor', max_length=100, verbose_name='Class implementation')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default', models.TextField(blank=True, help_text='Runner init param default value', max_length=500, null=True, verbose_name='Default Value')),
                ('prevent_override', models.BooleanField(default=True, help_text='Prevent service to override this value ', verbose_name='Prevent service override')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edam_topics', models.TextField(help_text='Comma separated list of Edam ontology topics', null=True, verbose_name='Edam topics')),
                ('edam_operations', models.TextField(help_text='Comma separated list of Edam ontology operations', null=True, verbose_name='Edam operations')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(storage=waves.models.storage.WavesStorage(), upload_to=waves.models.submissions.service_sample_directory, verbose_name='File')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edam_format', models.CharField(blank=True, help_text='Output expected Edam format', max_length=255, null=True, verbose_name='Edam format')),
                ('edam_data', models.CharField(blank=True, help_text='Output expected Edam data', max_length=255, null=True, verbose_name='Edam data')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('_value', models.CharField(blank=True, db_column='value', help_text='Runner init param value for this service', max_length=255, null=True, verbose_name='Param value')),
        ...
        migrations.CreateModel(
            name='ServiceSampleDependentInput',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_to', models.ForeignKey(help_text='Input is associated to', on_delete=django.db.models.deletion.CASCADE, related_name='dependents', to='waves.SubmissionInput')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='service_inputs', to='waves.ServiceSubmission')),
            ],
        ),
        migrations.CreateModel(
            name='WavesProfile',
        ...
        migrations.AddField(
            ...
            name='service',
            field=models.ForeignKey(help_text='Output associated service', on_delete=django.db.models.deletion.CASCADE, related_name='outputs', to='waves.ServiceSubmission'),
        ),
        migrations.AddField(
            model_name='serviceinputsample',
            name='service',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='services_sample', to='waves.ServiceSubmission'),
        ),
        migrations.AddField(
            model_name='service',
            name='category',
        ...
        migrations.AddField(
            model_name='job',
            name='submission',
            field=models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='waves.ServiceSubmission'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='servicesampledependentinput',
            name='dependent_input',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='waves.ServiceInput'),
        ),
        migrations.AlterUniqueTogether(
            name='servicerunnerparam',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Output is valued from an input', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='to_output', to='waves.ServiceInput'),
        ),
        migrations.AlterUniqueTogether(
            name='servicemeta',
        ...
        migrations.AddField(
            model_name='serviceinputsample',
            name='dependent_inputs',
            field=models.ManyToManyField(blank=True, through='waves.ServiceSampleDependentInput', to='waves.ServiceInput'),
        ),
        migrations.AddField(
            model_name='serviceinputsample',
            name='input',
