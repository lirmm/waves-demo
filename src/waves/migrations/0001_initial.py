# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-24 17:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('importer_clazz', models.CharField(blank=True, choices=[(b'Galaxy Tool Importer', b'waves.adaptors.importers.galaxy.GalaxyToolImporter'), (b'Galaxy Workflow Importer', b'waves.adaptors.importers.galaxy.GalaxyWorkflowImporter')], max_length=200, null=True, verbose_name='Importer')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(default='default', max_length=255, null=True, verbose_name='Submission title')),
                ('override_runner', models.ForeignKey(blank=True, help_text='Override service runs parameters', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='submission_runs', to='waves.Runner')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_pattern', models.CharField(blank=True, default='%s', help_text="Pattern used when dependent on any input '%s'", max_length=100, verbose_name='File name / pattern')),
