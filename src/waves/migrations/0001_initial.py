# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-20 13:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crypt', models.BooleanField(default=False, editable=False, verbose_name='Crypted')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cmd_format', models.IntegerField(choices=[(0, 'Not used'), (2, 'Simple (-[name] value)'), (1, 'Named (--[name]=value)'), (3, 'Option (-[name])'), (5, 'Named option (--[name])'), (4, 'Positional')], default=2, help_text='Command line pattern', verbose_name='Command line format')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(-1, 'Unknown'), (0, 'Created'), (1, 'Prepared for run'), (2, 'Queued'), (3, 'Running'), (4, 'Suspended'), (5, 'Run completed'), (6, 'Results available'), (7, 'Cancelled'), (9, 'In Error')], default=0, help_text='Job current run status', verbose_name='Job status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(-1, 'Unknown'), (0, 'Created'), (1, 'Prepared for run'), (2, 'Queued'), (3, 'Running'), (4, 'Suspended'), (5, 'Run completed'), (6, 'Results available'), (7, 'Cancelled'), (9, 'In Error')], help_text=b'History job status', null=True, verbose_name=b'Job Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('file', 'Input file'), ('list', 'List of values'), ('boolean', 'Boolean'), ('number', 'Decimal'), ('int', 'Integer'), ('text', 'Text')], editable=False, max_length=50, null=True, verbose_name='Param type')),
                ('name', models.CharField(editable=False, max_length=200, null=True, verbose_name='Param name')),
                ('param_type', models.IntegerField(choices=[(0, 'Not used'), (2, 'Simple (-[name] value)'), (1, 'Named (--[name]=value)'), (3, 'Option (-[name])'), (5, 'Named option (--[name])'), (4, 'Positional')], default=4, editable=False, verbose_name='Parameter Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, help_text='Output file name', max_length=200, verbose_name='File name')),
                ('ext', models.CharField(blank=True, max_length=5, null=True, verbose_name='File extension')),
                ('optional', models.BooleanField(default=False, verbose_name='May be empty ?')),
                ('file_pattern', models.CharField(blank=True, default='%s', help_text='Pattern used to match input value (%s to retrieve value from input)', max_length=100, verbose_name='File name / pattern')),
                ...
                ('help_text', models.TextField(blank=True, null=True, verbose_name='Content description')),
        ...
        migrations.CreateModel(
            name='WavesConfigVar',
            fields=[
                ('name', models.CharField(max_length=200, primary_key=True, serialize=False, verbose_name='Var name')),
                ('value', models.CharField(max_length=255, verbose_name='Config Value')),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('theme', models.CharField(choices=[(b'default', b'Default'), (b'amelia', b'Amelia'), (b'cerulean', b'Cerulean'), (b'cosmo', b'Cosmo'), (b'cyborg', b'Cyborg'), (b'flatly', b'Flatly'), (b'journal', b'Journal'), (b'readable', b'Readable'), (b'simplex', b'Simplex'), (b'slate', b'Slate'), (b'spacelab', b'SpaceLab'), (b'united', b'United'), (b'superhero', b'Superhero'), (b'lumen', b'Lumen')], default='default', max_length=255, verbose_name='Bootstrap theme')),
                ('allow_registration', models.BooleanField(default=True, help_text='Allow user registration', verbose_name='Registration')),
                ('allow_submits', models.BooleanField(default=True, help_text='Globally set if job can be submitted', verbose_name='Allow job submissions')),
                ('maintenance', models.BooleanField(default=False, help_text='Redirect everything to 503', verbose_name='Site Maintenance')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='wavesconfigvar',
            name='config',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='config_vars', to='waves.WavesSiteConfig'),
        ),
        migrations.AddField(
            model_name='service',
            name='category',
        ...
        migrations.AddField(
            ...
            name='submission',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sample_dependent_params', to='waves.Submission'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            name='BooleanParam',
            fields=[
                ('textparam_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='waves.TextParam')),
        ...
        migrations.AddField(
            ...
            name='from_input',
            field=models.ForeignKey(blank=True, help_text='Valuated with input', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='to_outputs', to='waves.TextParam'),
        ),
        ...
        migrations.AddField(
            model_name='sampledepparam',
            name='related_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_samples', to='waves.TextParam'),
        ),
        migrations.AddField(
            model_name='sampledepparam',
            name='sample',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, through='waves.SampleDepParam', to='waves.TextParam'),
        ),
        migrations.CreateModel(
            name='RelatedParam',
            fields=[
