    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_input_pattern', models.CharField(blank=True, help_text="Format related input value ('%s' is the related value)", max_length=100, null=True, verbose_name='Apply format')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default', models.BooleanField(default=True, verbose_name='Default submission')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('theme', models.CharField(choices=[(b'default', b'Default'), (b'amelia', b'Amelia'), (b'cerulean', b'Cerulean'), (b'cosmo', b'Cosmo'), (b'cyborg', b'Cyborg'), (b'flatly', b'Flatly'), (b'journal', b'Journal'), (b'readable', b'Readable'), (b'simplex', b'Simplex'), (b'slate', b'Slate'), (b'spacelab', b'SpaceLab'), (b'united', b'United'), (b'superhero', b'Superhero'), (b'lumen', b'Lumen')], default='flatly', max_length=255)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, db_table='waves_service_client', help_text='By default access is granted to everyone, you may restrict access here.', related_name='restricted_services', to='waves.APIProfile', verbose_name='Restricted clients'),
        ),
        migrations.AddField(
            model_name='service',
            name='run_on',
        ...
        migrations.AlterUniqueTogether(
            name='servicesubmission',
            unique_together=set([('service', 'api_name'), ('service', 'default')]),
        ),
        migrations.AlterUniqueTogether(
            name='servicerunnerparam',
        ...
        migrations.AlterUniqueTogether(
            name='servicemeta',
            unique_together=set([('type', 'title', 'value')]),
        ),
        migrations.AddField(
            model_name='serviceinputsample',
