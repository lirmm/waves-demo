# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-07-06 16:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('timestamp', models.DateTimeField(help_text='History timestamp', verbose_name='Date time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display', models.CharField(blank=True, choices=[('select', 'Select List'), ('mselect', 'Multiple select'), ('radio', 'Radio buttons'), ('checkbox', 'Check box')], default='select', help_text='Input list display mode (for type list only)', max_length=100, null=True, verbose_name='List display type')),
            ],
            options={
                'ordering': ['order'],
