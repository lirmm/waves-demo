# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-03 13:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', polymorphic_tree.models.PolymorphicTreeForeignKey(blank=True, help_text='Input is associated to', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dependents_inputs', to='waves.AParam')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(-1, 'Unknown'), (0, 'Created'), (1, 'Prepared for run'), (2, 'Queued'), (3, 'Running'), (4, 'Suspended'), (5, 'Run completed'), (6, 'Finished'), (7, 'Cancelled'), (9, 'In Error')], default=0, help_text='Job current run status', verbose_name='Job status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(-1, 'Unknown'), (0, 'Created'), (1, 'Prepared for run'), (2, 'Queued'), (3, 'Running'), (4, 'Suspended'), (5, 'Run completed'), (6, 'Finished'), (7, 'Cancelled'), (9, 'In Error')], help_text=b'History job status', null=True, verbose_name=b'Job Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('help_text', models.TextField(blank=True, null=True, verbose_name='Help Text')),
                ('from_input', models.ForeignKey(blank=True, help_text='Valuated with input', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='to_outputs', to='waves.AParam')),
