...
urlpatterns = [
    ...
    url(r'^register/complete/$',
        TemplateView.as_view(template_name='../../accounts/templates/accounts/registration_complete.html'),
        name='registration_complete'),
    url(r'^register/closed/$',
        TemplateView.as_view(template_name='../../accounts/templates/accounts/registration_closed.html'),
    ...
    url(r'^profile/$', waves.views.profiles.ShowProfile.as_view(), name='show_self'),
    url(r'^profile/edit$', waves.views.profiles.EditProfile.as_view(), name='edit_self'),
    url(r'^(?P<slug>[\w\-]+)$', waves.views.profiles.ShowProfile.as_view(),
        name='show'),
    url(r'^jobs/$', waves.views.jobs.JobListView.as_view(), name="job_list"),
]
