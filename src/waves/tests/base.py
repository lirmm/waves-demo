...
waves.settings.WAVES_JOB_DIR = str(os.path.join(dirname(settings.BASE_DIR), 'tests', 'data', 'jobs'))
waves.settings.WAVES_DATA_ROOT = str(os.path.join(dirname(settings.BASE_DIR), 'tests', 'data'))
waves.settings.WAVES_SAMPLE_DIR = str(os.path.join(dirname(settings.BASE_DIR), 'tests', 'data', 'sample'))
